...
<style>
    ...
    .stylist-card-modern:hover .stylist-img {
    ...
    .btn-modern-book {
        ...
        box-shadow: 0 10px 20px rgba(62, 43, 38, 0.2);
        transition: all 0.3s;
        border: none;
    }

    .btn-modern-book:hover {
        box-shadow: 0 15px 30px rgba(62, 43, 38, 0.3);
        transform: translateY(-2px);
        background: linear-gradient(135deg, #5d4037 0%, #3e2b26 100%);
        color: #fff;
    }
