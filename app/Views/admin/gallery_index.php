...
<style>
    ...
    .gallery-item {
        display: flex; /* Layout Horizontal (Gambar di kiri, Teks di kanan) */
    ...
    .gallery-item:hover {
        transform: translateX(5px); /* Efek geser kanan sedikit saat hover */
    ...
    .gallery-img-box img {
        ...
        object-fit: cover; /* Memenuhi area portrait */
    ...
    .item-desc {
        ...
        line-height: 1.6;
        margin-bottom: 20px;
        flex-grow: 1; /* Mendorong tombol ke bawah jika teks sedikit */
        /* Batasi baris teks */
        display: -webkit-box;
        -webkit-line-clamp: 4;
    ...
    @media (max-width: 768px) {
        ...
        .gallery-img-box {
            width: 100%;
            height: 300px; /* Tinggi gambar di HP */
        }
        .gallery-content {
            padding: 20px;
        }
