...
<style>
    ...
    .capster-list { display: flex; flex-direction: column; gap: 20px; }
    ...
    .capster-avatar {
        ...
        border: 3px solid #fdf5e6; box-shadow: 0 4px 10px rgba(0,0,0,0.1);
    }

    /* INFO SECTION */
    .capster-info { flex-grow: 1; display: flex; flex-direction: column; justify-content: center; }
    
    .capster-name {
        font-size: 1.2rem; font-weight: 700; color: var(--primary-brown);
        margin: 0 0 5px 0; font-family: 'Playfair Display', serif; display: flex; align-items: center; gap: 10px;
    }
    
    .capster-details {
        display: flex; gap: 15px; align-items: center; font-size: 0.9rem; color: var(--text-muted);
    }
    ...
    /* ACTIONS BUTTONS */
    .capster-actions { display: flex; gap: 10px; margin-left: 20px; }
    ...
    @media (max-width: 768px) {
        ...
        .btn-add-capster { width: 100%; justify-content: center; }
        
        .capster-card { flex-direction: column; text-align: center; padding: 30px 20px; }
        .capster-avatar { margin: 0 0 15px 0; width: 90px; height: 90px; }
        .capster-info { width: 100%; align-items: center; }
        .capster-name { justify-content: center; flex-wrap: wrap; }
        .capster-details { justify-content: center; flex-wrap: wrap; margin-top: 10px; }
        
        .capster-actions { 
            margin: 20px 0 0 0; width: 100%; justify-content: center; 
