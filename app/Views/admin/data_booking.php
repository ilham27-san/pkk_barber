...
<style>
    ...
    :root {
        ...
        /* Status Colors */
        --status-pending-bg: #fff3e0; --status-pending-text: #e65100;
        --status-confirmed-bg: #e3f2fd; --status-confirmed-text: #1565c0;
        --status-done-bg: #e8f5e9; --status-done-text: #2e7d32;
        --status-canceled-bg: #ffebee; --status-canceled-text: #c62828;
    }
    ...
    .admin-wrapper {
        padding: 50px 20px;
        min-height: 90vh;
        max-width: 1200px; /* Lebih lebar karena tabel booking banyak kolom */
        margin: 0 auto;
    }
    ...
    .btn-add {
        ...
        box-shadow: 0 4px 10px rgba(62, 43, 38, 0.2); transition: all 0.3s;
    }
    .btn-add:hover { background-color: var(--secondary-brown); transform: translateY(-2px); }
    ...
    /* TABLE STYLING */
    .custom-table {
        width: 100%; border-collapse: collapse; margin: 0; white-space: nowrap;
    }

    /* Table Head */
    .custom-table thead {
        background-color: #fcf8f3; border-bottom: 2px solid #e0d0c0;
    }
    ...
    /* Customer Info */
    .customer-name { font-weight: 700; color: var(--primary-brown); display: block; margin-bottom: 3px; }
    .booking-id { font-size: 0.75rem; color: #aaa; background: #f5f5f5; padding: 2px 6px; border-radius: 4px; }

    /* Contact Info */
    .contact-info { display: flex; flex-direction: column; gap: 3px; font-size: 0.85rem; color: var(--text-muted); }
    .contact-info i { width: 15px; text-align: center; margin-right: 5px; color: var(--accent-gold); }

    /* Service & Stylist */
    .service-badge { font-weight: 600; color: var(--text-dark); }
    .stylist-name { color: var(--text-muted); font-size: 0.85rem; font-style: italic; }

    /* Date & Time */
    .datetime-box { text-align: center; border: 1px solid #eee; padding: 5px 10px; border-radius: 8px; background: #fff; }
    .date-val { font-weight: 700; display: block; }
    .time-val { font-size: 0.8rem; color: var(--text-muted); }
    ...
    /* EMPTY STATE */
    .empty-state-row { text-align: center; padding: 50px !important; }
    .empty-content { color: #ccc; display: flex; flex-direction: column; align-items: center; gap: 10px; }
