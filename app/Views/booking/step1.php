                ...
                <?php foreach ($layanan as $l): ?>
                    <div class="layanan-card" id="card-<?= $l['id'] ?>" onclick="selectCard(this, '<?= $l['id'] ?>', '<?= $l['harga'] ?>')">
                        ...
                        <div class="card-content">
                            ...
                            <p class="layanan-desc">Perawatan terbaik untukmu</p>
                        </div>
            ...
            <form action="/booking/step1Submit" method="post" class="booking-form">
                ...
                <div class="action-item center-item">
                    <select name="id_capster" id="id_capster" class="custom-select">
                        ...
                        <option value="">-- Pilih Stylist (Bebas/Opsional) --</option>
    ...
    <style>
        ...
        .layanan-card:last-child {
            grid-column: 1 / -1;
            /* Membentang dari kolom 1 sampai akhir */
            display: flex;
            flex-direction: row;
        ...
        @media (max-width: 768px) {
            .floating-action-bar {
                ...
                padding: 15px;
                border-radius: 20px;
                /* Di HP agak kotak dikit biar muat */
                flex-direction: column;
            }

            .booking-form {
                flex-direction: row;
                /* Tetap baris tapi wrap */
                flex-wrap: wrap;
                justify-content: space-between;
            }
