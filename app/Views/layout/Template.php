...
<body>
    ...
    <div class="container">
      ...
      <div class="logo">
        <a href="<?= base_url('/'); ?>" class="brand-wrapper">
          <img src="<?= base_url('assets/images/logo.png') ?>" alt="SANBARBERS Logo">
        </a>
      </div>
      ...
      <nav class="main-nav">
        ...
        <ul>
          ...
          <li class="dropdown">
            <a href="javascript:void(0)" class="<?= ($segment1 == 'about') ? 'active' : '' ?>">About Us ▾</a>
          ...
          <li class="dropdown">
            <a href="javascript:void(0)" class="<?= ($segment1 == 'layanan') ? 'active' : '' ?>">Service ▾</a>
            <ul class="dropdown-menu">
          ...
          <?php if (session()->get('logged_in')): ?>
            <li class="user-info"><span>Hi, <?= session()->get('username') ?></span></li>
  ...
  <footer class="main-footer">
    <div class="container">
      <p>&copy; <?= date('Y') ?> <strong>SANBARBERS</strong>. All Rights Reserved.</p>
    </div>
  </footer>
