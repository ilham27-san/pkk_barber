...
<style>
    ...
    .write-review-area {
        flex-grow: 1;
        /* Area ini akan mengambil sisa ruang kosong */
        display: flex;
        flex-direction: column;
    }
    ...
    .review-form-flex {
        ...
        flex-direction: column;
        flex-grow: 1;
        /* Mengisi ruang sisa di sidebar */
    }

    .form-group-review {
        flex-grow: 1;
        /* Ini membuat div pembungkus textarea memanjang */
        display: flex;
        flex-direction: column;
        margin-bottom: 15px;
    }
    ...
    .input-review-text {
        ...
        font-family: 'Montserrat', sans-serif;
        resize: none;
        /* User gabisa resize manual biar ga rusak layout */
        font-size: 0.95rem;

        flex-grow: 1;
        /* Textarea akan memanjang sampai bawah */
        height: 100%;
    }

    .input-review-text:focus {
        outline: none;
        border-color: #cba155;
        background: #fffbf5;
    }
    ...
    .btn-submit-review {
        ...
        transition: all 0.3s;
        margin-top: auto;
        /* Pastikan tombol di paling bawah */
    }
    ...
    .review-card-item {
        ...
        border-radius: 15px;
        padding: 20px;
        /* Padding sedikit dikecilkan biar muat 3 pas */
