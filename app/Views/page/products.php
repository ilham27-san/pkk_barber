...
<style>
    /* --- RESET & FONTS --- */
    .products-section { font-family: 'Montserrat', sans-serif; padding: 60px 0; }
    
    /* --- HEADER --- */
    .section-title {
        text-align: center; margin-bottom: 10px;
        font-family: 'Playfair Display', serif; font-size: 3rem; color: var(--dark-brown, #3e2b26);
        font-weight: 700; letter-spacing: 1px;
    }

    .section-subtitle {
        text-align: center; color: #666; font-size: 1.1rem;
        max-width: 700px; margin: 0 auto 60px; line-height: 1.6; font-weight: 400;
    }
    ...
    .product-title { 
        font-size: 1.25rem; margin: 0 0 5px; color: #333; 
        font-weight: 700; font-family: 'Playfair Display', serif; 
        line-height: 1.3;
    }
    
    .product-price { 
        color: var(--primary-red, #c0392b); font-weight: 700; 
        font-size: 1.1rem; display: block; margin-top: 5px;
    }
    
    .product-desc { 
        font-size: 0.9rem; color: #777; margin-bottom: 25px; 
        line-height: 1.6;
    ...
    /* --- BUTTON --- */
    .btn-pill {
        background: var(--dark-brown, #3e2b26); color: white;
        border: none; padding: 14px 20px; border-radius: 50px;
        cursor: pointer; font-weight: 600; transition: all 0.3s;
        width: 100%; font-size: 0.95rem; letter-spacing: 0.5px;
    ...
    .floating-cart-btn {
        ...
        background: var(--dark-brown, #3e2b26); color: #fff;
    ...
    .qty-control { display: flex; align-items: center; gap: 10px; justify-content: center; margin: 30px 0; }
    .qty-btn { width: 40px; height: 40px; border-radius: 50%; border: 1px solid #ddd; background: #fff; cursor: pointer; font-weight: bold; font-size: 1.2rem; transition: all 0.2s; }
    .qty-btn:hover { background: #f5f5f5; }

    .cart-item { display: flex; justify-content: space-between; align-items: center; padding: 15px 0; border-bottom: 1px dashed #eee; }
    .cart-item-info { display: flex; flex-direction: column; text-align: left; }
    .cart-item-title { font-weight: 600; font-size: 1rem; color: #333; }
    .cart-item-price { font-size: 0.9rem; color: #888; }
    .cart-item-actions { display: flex; align-items: center; gap: 15px; }
    .cart-item-subtotal { font-weight: 700; font-size: 1rem; color: var(--primary-red); }
    .btn-remove-item { border: none; background: none; color: #ccc; cursor: pointer; font-size: 1.1rem; }
    .btn-remove-item:hover { color: #e74c3c; }
    .cart-footer { margin-top: 25px; }
    .cart-total-row { display: flex; justify-content: space-between; font-weight: 700; font-size: 1.2rem; margin-bottom: 20px; color: #333; }
    .btn-checkout-wa {
        background: #25D366; color: #fff; width: 100%; border: none;
        ...
        box-shadow: 0 5px 15px rgba(37, 211, 102, 0.3); transition: all 0.3s;
    }
    .btn-checkout-wa:hover { background: #128C7E; transform: translateY(-2px); }
</style>
