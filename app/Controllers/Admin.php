...
class Admin extends Controller
{
    ...
    public function layanan()
    {
        ...
        echo view('layout/template', [
            'content' => view('admin/data_layanan', $data)
        ]);
    }
    ...
    {
        echo view('layout/template', [
            'content' => view('admin/form_layanan')
        ]);
    }
    ...
    public function editLayanan($id)
    {
        ...
        echo view('layout/template', [
            'content' => view('admin/form_layanan', $data)
        ]);
    }
    ...
    public function pelanggan()
    {
        ...
        echo view('layout/template', [
            'content' => view('admin/data_pelanggan', $data)
        ]);
    }
    ...
    public function bookings()
    {
        ...
        echo view('layout/template', [
            'content' => view('admin/data_booking', $data)
        ]);
    }
}
